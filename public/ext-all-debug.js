...
Ext.grid.GridPanel = Ext.extend(Ext.Panel, {
    ...
    applyState : function(state){
        ...
        if(state.sort){
            this.store[this.store.remoteSort ? 'setDefaultSort' : 'sort'](state.sort[0].field, state.sort[0].direction);
        }
    },
...
Ext.grid.GroupingView = Ext.extend(Ext.grid.GridView, {
    ...
    renderRows : function(){
        ...
        if(this.hideGroupedColumn && colIndex > -1) {
